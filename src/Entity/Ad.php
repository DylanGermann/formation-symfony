 ...
 * @UniqueEntity(
 * fields={"title"}, message="Une autre annonce possède déja ce titre merci de le modifier !"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=20, minMessage="L'intro doit faire plus de 20 caractères !")
     */
